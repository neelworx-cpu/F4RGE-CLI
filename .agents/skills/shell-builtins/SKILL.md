---
name: shell-builtins
description: Use when creating a new shell builtin command for 4RGED (internal/shell/), editing an existing one, or when the user needs to understand how commands are intercepted in 4RGED's embedded shell.
---

# Shell Builtins

4RGED's shell (`internal/shell/`) uses `mvdan.cc/sh/v3` for POSIX shell
