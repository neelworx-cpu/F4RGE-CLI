...
func TestF4rgedInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildF4rgedInfo(cfg, nil, nil, nil, nil)
...
func TestF4rgedInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/4rged/4rged.json",
		"/project/.4rged/4rged.json",
	)
	output := buildF4rgedInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/4rged/4rged.json")
	require.Contains(t, output, "/project/.4rged/4rged.json")
}

func TestF4rgedInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildF4rgedInfo(cfg, mgr, nil, nil, nil)
...
func TestF4rgedInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.4rged",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.4rged")
	require.Contains(t, output, "debug = true")
}

func TestF4rgedInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildF4rgedInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildF4rgedInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestF4rgedInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "4rged.json")
	...
	output := buildF4rgedInfo(store, nil, nil, nil, nil)
...
func TestF4rgedInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "4rged-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("4rged-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildF4rgedInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "4rged-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestF4rgedInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "4rged-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestF4rgedInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestF4rgedInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
